...
export const COLLAPSED_HEADER_SEARCH_STYLES = getSearchStyles(false, false);

function getSearchStyles(hero: boolean, expanded: boolean): StylesConfig<SearchOption, false> {
  return {
